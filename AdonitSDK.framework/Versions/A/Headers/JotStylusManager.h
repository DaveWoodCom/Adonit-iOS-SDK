...
/**
 * The current button 3 shortcut of the connected stylus
 */
@property (nonatomic, assign) JotShortcut *button3Shortcut;

/**
 * The current button 4 shortcut of the connected stylus
 */
@property (nonatomic, assign) JotShortcut *button4Shortcut;
